...
if __name__ == "__main__":
    ...
    file_name = "boolean_networks_control.csv"
    file_path = os.path.join(dir_path, file_name)
    with open(file_path, "r") as file:
        dois = file.readlines()

    file_path = os.path.join(dir_path, "boolean_networks_control_template.html")
    ...
    file_path = os.path.join(dir_path, "boolean_networks_control.html")
    if html_content:
